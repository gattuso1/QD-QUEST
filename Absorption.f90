...
allocate(TransDip_eix(nQD,0:nstates-1,0:nstates-1))
allocate(Energy(nQD,0:nstates-1))

do n=1,nQD

read(20,*) dummy , dummy2 , Energy(n,1), Energy(n,2)
...
deallocate(TransDip_eix,Energy)

nstates=9

allocate(TransDip_eix(ndim+nQD,0:nstates-1,0:nstates-1))
allocate(Energy(ndim+nQD,0:nstates-1))
