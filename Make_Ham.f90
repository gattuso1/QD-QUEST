...
Ham(25,25)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Dso1/3.d0 - 3.d0*Kas)
Ham(26,26)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Dso1/3.d0 - 3.d0*Kcs)
Ham(27,27)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Kas)
Ham(28,28)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kas)
Ham(29,29)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kbs + Dxf)
Ham(30,30)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kbs + Dxf)
Ham(31,31)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Kcs)
Ham(32,32)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kcs)
Ham(33,33)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  + elec*(Dso1/3.d0 - 3.d0*Kas)
Ham(34,34)   = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Kbs + Dxf)
Ham(35,35)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kbs + Dxf)
Ham(36,36)   = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  + elec*(Dso1/3.d0 - 3.d0*Kcs)

Ham(27,28)  = elec*(-1.d0*Dso1/3.d0)
Ham(28,27)  = Ham(27,28)
Ham(27,29)  = Ham(27,28)
Ham(29,27)  = Ham(27,28)
Ham(30,31)  = Ham(27,28)
...
Ham(37,37)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Dso1/3.d0 - 3.d0*Kas)
Ham(38,38)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Dso1/3.d0 - 3.d0*Kcs)
Ham(39,39)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Kas)
Ham(40,40)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kas)
Ham(41,41)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kbs + Dxf)
Ham(42,42)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kbs + Dxf)
Ham(43,43)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Kcs)
Ham(44,44)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kcs)
Ham(45,45)  = minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  + elec*(Dso1/3.d0 - 3.d0*Kas)
Ham(46,46)= minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(Kbs + Dxf)
Ham(47,47)= minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  - elec*(3.d0*Kbs + Dxf)
Ham(48,48)= minEe(1,n+ndim) + minEh(1,n+ndim)  + V0  + elec*(Dso1/3.d0 - 3.d0*Kcs)

Ham(39,40)  = elec*(-1.d0*Dso1/3.d0)
Ham(40,39)  = Ham(39,40)
Ham(39,41)  = Ham(39,40)
Ham(41,39)  = Ham(39,40)
Ham(42,43)  = Ham(39,40)
...
TransHam(0,19) = abs(TransDip_Ana_h2e(n))
TransHam(0,22) = abs(TransDip_Ana_h2e(n))
TransHam(0,27) = abs(TransDip_Ana_h1e(n))
TransHam(0,31) = abs(TransDip_Ana_h1e(n)) 
TransHam(0,34) = abs(TransDip_Ana_h1e(n))
TransHam(0,39) = abs(TransDip_Ana_h2e(n))
TransHam(0,43) = abs(TransDip_Ana_h2e(n))
TransHam(0,46) = abs(TransDip_Ana_h2e(n))
