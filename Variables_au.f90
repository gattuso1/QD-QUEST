...
implicit none
   ...
   character*1 :: rdm_ori, noMat, Dyn_avg, doDmat, Dec_L
   ...
   real(dp),allocatable :: Matx(:,:), Maty(:,:), Matz(:,:),spec(:),dipole(:,:), Ham0_avg(:,:), sigD(:,:)
...
NAMELIST /outputs/   inbox,rdm_ori,get_sp,get_ei,Dyn_0,Dyn_ei,Dyn_L,Dec_L,Dyn_avg,TDM_ee,&
